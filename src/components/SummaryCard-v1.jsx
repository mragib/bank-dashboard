...
const SummaryCard = () => {
  return (
    <div className="min-w-[350px] w-full min-h-[235px] rounded-[25px] bg-gradient-to-r from-[#4C49ED] to-[#0A06F4] via-[#3A38E0] flex flex-col text-white">
          ...
          >
            ...
            <defs>
              <pattern
                ...
                height="1"
              >
                <use xlinkHref="#image0_0_345" transform="scale(0.01)" />
              </pattern>
              <image
                id="image0_0_345"
                width="100"
